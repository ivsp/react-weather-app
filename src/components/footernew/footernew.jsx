...
function Footer() {
  ...
  return (
    <Container className="mt-5 cardcontainer" fluid >
      <Card className="pt-5 pb-5 border-0" style={{"background-color":"#808080", color:"#f7f7f7", "font-size":"16px", width:"100%" }} >
        ...
        <Row className="newfootercontainer justify-content-between" style={{width:"93%"}}>
          ...
          <Col
            ...
            <Card.Text className="mb-2" style={{"font-weight":"600"}}>Dónde Comprar</Card.Text>
          ...
          <Col 
            ...
            <Card.Text className="mb-2" style={{"font-weight":"600"}}>Productos</Card.Text>
          ...
          <Col
            ...
            <Card.Text className="mb-2" style={{"font-weight":"600"}}>Servicios y soporte</Card.Text>
            ...
            <Card.Text className="m-0">Asesoramiento de servicio técnico</Card.Text>
          </Col>
          ...
          <Col
            ...
            <Card.Text className="mb-2" style={{"font-weight":"600"}}>Acerca de Nikon</Card.Text>
            <Card.Text className="m-0">Novedades</Card.Text>
            <Card.Text className="m-0">Responsabilidad social corporativa</Card.Text>
